          ...
          >
            ...
            <div className="p-4 sm:p-5 flex flex-col gap-3 flex-1">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-gray-100 mt-auto">
                ...
                <button
                  className="text-white bg-black w-fit px-2 py-3 cursor-pointer hover:bg-white hover:text-black transition-all duration-300 transform hover:scale-105 active:scale-95 shadow-md hover:shadow-lg font-semibold flex gap-2 rounded-lg"
                  onClick={() => agregarAlCarrito(item)}
                >
                  <Icon icon="mynaui:cart-plus-solid" width="24" height="24" />
                  Añadir
                </button>
              </div>
            </div>
