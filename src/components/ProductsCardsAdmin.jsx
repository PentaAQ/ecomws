...
export const ProductsCardsAdmin = () => {
  ...
  return (
    <article className="md:col-span-2 text-black flex flex-col h-[75vh] md:h-[85vh] max-md:order-2">
      ...
      >
        ...
        {data && data.length > 0 && totalPaginas > 1 && (
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 py-4 px-2 border-t border-gray-200 bg-white w-full">
